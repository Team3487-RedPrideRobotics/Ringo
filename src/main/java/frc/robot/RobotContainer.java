...
public class RobotContainer {
  ...
  // Joysticks
  public static XboxController m_driveController = new XboxController(1);
  ...
  private void configureButtonBindings() {
    ...
    //------------Driver Controls------------//
    //---------------------------------------//
    //Drives using arcade controls, Left Stick 
    //is forward/back right stick is left/right
    ...
    //---------------------------------------//
    //Intake when right trigger is pushed down
    ...
    //-----------Opeartor Controls-----------//
    //---------------------------------------//
    //In theory this will activate the shoot
    //motors at max speed on right trigger
    //press and disable them on release
    ...
    //new Trigger(m_shoot::operatorRightTrigger)
      //.onTrue(new ShootOut(m_shoot));
      //.onFalse(new DisableShootMotors(m_shoot));
